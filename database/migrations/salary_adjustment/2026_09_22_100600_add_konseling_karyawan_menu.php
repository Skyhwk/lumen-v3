...
{
    private const HRIS_GROUP_LABELS = ['HRIS', 'hris'];
    private const KONSELING_MENU = 'Konseling Karyawan';
    ...
    public function up(): void
    {
        ...
        $this->appendMenuToGroups(self::HRIS_GROUP_LABELS, self::KONSELING_MENU);
        $this->copyAccessFromReference('Konsultasi', self::KONSELING_MENU);
    }
    ...
    public function down(): void
    {
        ...
        $this->removeMenuFromGroups(self::HRIS_GROUP_LABELS, self::KONSELING_MENU);
        $this->removeAccess(self::KONSELING_MENU);
    }
