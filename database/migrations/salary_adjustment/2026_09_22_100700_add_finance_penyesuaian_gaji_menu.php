...
{
    private const FINANCE_GROUP_LABELS = ['Finance', 'finance'];
    private const FINANCE_MENU = 'Pengajuan Penyesuaian Gaji';
    ...
    public function up(): void
    {
        ...
        $this->appendMenuToGroups(self::FINANCE_GROUP_LABELS, self::FINANCE_MENU);
        $this->copyAccessFromReference('Finance Decision', self::FINANCE_MENU);
    }
    ...
    public function down(): void
    {
        ...
        $this->removeMenuFromGroups(self::FINANCE_GROUP_LABELS, self::FINANCE_MENU);
        $this->removeAccess(self::FINANCE_MENU);
    }
