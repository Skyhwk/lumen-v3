...
return new class extends Migration
{
    ...
    private const KPI_MENU = 'Kriteria KPI Penyesuaian Gaji';
    ...
    public function up(): void
    {
        ...
        $this->appendMenuToGroups(self::PAYROLL_GROUP_LABELS, self::KPI_MENU);
        $this->copyAccessFromReference('Master Sallary', self::KPI_MENU);
    }
    ...
    public function down(): void
    {
        ...
        $this->removeMenuFromGroups(self::PAYROLL_GROUP_LABELS, self::KPI_MENU);
        $this->removeAccess(self::KPI_MENU);
    }
