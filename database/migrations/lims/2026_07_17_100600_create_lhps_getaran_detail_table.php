...
class CreateLhpsGetaranDetailTable extends Migration
{
    public function up(): void
    {
        Schema::create('lhps_getaran_detail', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('id_header')->nullable();
            $table->string('no_sampel', 50)->nullable();
            $table->text('keterangan')->nullable();
            $table->string('aktivitas', 100)->nullable();
            $table->string('sumber_get', 255)->nullable();
    ...
    {
        Schema::dropIfExists('lhps_getaran_detail');
    }
}
