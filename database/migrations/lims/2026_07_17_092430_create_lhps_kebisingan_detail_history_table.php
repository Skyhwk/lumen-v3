...
class CreateLhpsKebisinganDetailHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('lhps_kebisingan_detail_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_kebisingan_detail_history');
    }
}
