...
class CreateLhpsKebisinganPersonalHeaderHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('lhps_kebisingan_personal_header_history', function (Blueprint $table) {
            $table->increments('id');
            ...
            // Kondisi Lingkungan & Regulasi
            $table->string('suhu', 50)->nullable();
            $table->string('kelembapan', 50)->nullable();
    ...
    {
        Schema::dropIfExists('lhps_kebisingan_personal_header_history');
    }
}
