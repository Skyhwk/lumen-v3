...
class CreateLhpsKebisinganHeaderHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('lhps_kebisingan_header_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_kebisingan_header_history');
    }
}
