...
class CreateLhpsEmisiIsokinetikHeaderTable extends Migration
{
    public function up(): void
    {
        Schema::create('lhps_emisi_isokinetik_header', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_emisi_isokinetik_header');
    }
}
