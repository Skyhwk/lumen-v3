...
class CreateLhpsKebisinganCustomTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('lhps_kebisingan_custom', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_kebisingan_custom');
    }
}
