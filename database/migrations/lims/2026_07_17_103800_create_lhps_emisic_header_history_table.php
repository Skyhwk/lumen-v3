...
class CreateLhpsEmisicHeaderHistoryTable extends Migration
{
    public function up(): void
    {
        Schema::create('lhps_emisic_header_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_emisic_header_history');
    }
}
