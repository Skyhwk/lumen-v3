...
class CreateLhpsEmisiIsokinetikDetailHistoryTable extends Migration
{
    public function up(): void
    {
        Schema::create('lhps_emisi_isokinetik_detail_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_emisi_isokinetik_detail_history');
    }
}
