...
class CreateLhpsGetaranDetailHistoryTable extends Migration
{
    public function up(): void
    {
        Schema::create('lhps_getaran_detail_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_getaran_detail_history');
    }
}
