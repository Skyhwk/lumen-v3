...
class CreateLhpsKebisinganPersonalHeaderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('lhps_kebisingan_personal_header', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_kebisingan_personal_header');
    }
}
