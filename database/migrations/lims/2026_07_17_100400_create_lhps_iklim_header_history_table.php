...
class CreateLhpsIklimHeaderHistoryTable extends Migration
{
    public function up(): void
    {
        Schema::create('lhps_iklim_header_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_iklim_header_history');
    }
}
