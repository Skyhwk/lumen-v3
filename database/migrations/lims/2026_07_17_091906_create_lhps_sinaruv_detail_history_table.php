...
class CreateLhpsSinaruvDetailHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('lhps_sinaruv_detail_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_sinaruv_detail_history');
    }
}
