...
class CreateLhpsGetaranHeaderTable extends Migration
{
    public function up(): void
    {
        Schema::create('lhps_getaran_header', function (Blueprint $table) {
            $table->increments('id');
            $table->string('no_order', 100)->nullable();
            $table->string('no_lhp', 100)->nullable();
            ...
            $table->string('tanggal_terima', 100)->nullable();
    ...
    {
        Schema::dropIfExists('lhps_getaran_header');
    }
}
