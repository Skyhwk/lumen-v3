...
class CreateLhpsMedanlmHeaderHistoryTable extends Migration
{
    public function up(): void
    {
        Schema::create('lhps_medanlm_header_history', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('metode_sampling', 100)->nullable();
            $table->date('tanggal_sampling')->nullable();
            $table->json('hasil_observasi')->nullable();
            ...
            $table->string('deskripsi_titik', 100)->nullable();
            ...
            $table->json('informasi_sampling')->nullable();
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('lhps_medanlm_header_history');
    }
}
