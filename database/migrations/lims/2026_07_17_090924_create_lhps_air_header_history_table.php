...
class CreateLhpsAirHeaderHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('lhps_air_header_history', function (Blueprint $table) {
            $table->bigInteger('id'); // Tanpa auto_increment
            ...
            $table->string('deskripsi_titik', 100)->nullable(); // Di history varchar(100), di master varchar(255)
    ...
    {
        Schema::dropIfExists('lhps_air_header_history');
    }
}
