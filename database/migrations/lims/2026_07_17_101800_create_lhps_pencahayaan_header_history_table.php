...
class CreateLhpsPencahayaanHeaderHistoryTable extends Migration
{
    public function up(): void
    {
        Schema::create('lhps_pencahayaan_header_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lhps_pencahayaan_header_history');
    }
}
