...
class CreateDataLapanganLingkunganKerjaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('data_lapangan_lingkungan_kerja', function (Blueprint $table) {
            $table->id();
            ...
            // Indexing
            $table->index('no_sampel', 'idx_dllk_no_sampel');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('data_lapangan_lingkungan_kerja');
    }
}
