...
class CreateLhpsLingHeaderHistoryTable extends Migration
{
    public function up(): void
    {
        Schema::create('lhps_ling_header_history', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('lhps_ling_header_history');
    }
}
