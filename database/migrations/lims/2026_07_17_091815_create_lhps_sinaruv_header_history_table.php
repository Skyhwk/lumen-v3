...
class CreateLhpsSinaruvHeaderHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('lhps_sinaruv_header_history', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('rejected_by', 150)->nullable(); // Di history varchar(150), master 70
    ...
    {
        Schema::dropIfExists('lhps_sinaruv_header_history');
    }
}
