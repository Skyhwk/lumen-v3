...
class HelperSatuan
{
    ...
    {
        $templateSatuan = TemplateSatuan::where('kategori', 'udara')->where('satuan', $satuan)->where('is_active', true)->first();
        if ($templateSatuan) {
            return $templateSatuan->column_number;
        } else {
            return null;
        }
    ...
    public static function emisi($satuan)
    {
        ...
        if ($templateSatuan) {
            return $templateSatuan->column_number == 0 ? "" : $templateSatuan->column_number;
        } else {
            return null;
        }
