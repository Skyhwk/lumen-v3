            ...
            foreach ($periodRange as $index => $period) {
                ...
                if($period < Carbon::now()->format('Y-m')) {
                    ...
                    foreach ($dataSource as $item) {
                        ...
                        $summary = [
                            'category' => json_decode($item->achieved_category, true),
                            'amount' => [
                                'target'               => $item->target_amount,
                                'achieved'             => $item->achieved_amount,
                                'rate'                 => $item->rate,
                                'percentage'           => $item->percentage_amount,
                                'basis'                => $item->basis,
                                'paid_achieved_amount' => $item->paid_achieved_amount,
                                'estimated_fee'        => $item->estimated_fee,
                                'claimed_fee'          => $item->claimed_fee,
                            ],
                        ];
