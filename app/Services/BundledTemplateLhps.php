...
class BundledTemplateLhps
{
    protected $pdf;
    protected $data;
    protected $fileName;

    public function lhpAir20Kolom($data, $data_detail, $mode_download, $data_custom, $custom2 = null, $mpdf)
    {
        ...
        $ress = self::formatTemplate($customBod, $header, $name, $ttd, $data->file_qr, $mode_download, $custom2, $mpdf);
        return $ress;
    }

    public function lhpAirLebih20Kolom($data, $data_detail, $mode_download, $data_custom, $custom2 = null, $mpdf)
    {
        $totData = $data->header_table ? count(json_decode($data->header_table)) : 0;
        $colc = '';
        $rowc = '';
    ...
    public function emisisumbertidakbergerak($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        $file_qr = '';
        $tanggal_qr = '';
        if (!is_null($data->file_qr) && $mode_download != 'downloadWSDraft') {
        ...
        $no_lhp = str_replace("/", "-", $data->no_lhp);
        $name = 'LHP-' . $no_lhp . '.pdf';
        $ress = self::formatTemplate($customBod, $header, $name, $ttd, $data->file_qr, $mode_download, null, $mpdf);
        return $ress;
    }
    public function DirectESBBensin($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        $file_qr = '';
        $tanggal_qr = '';
        if (!is_null($data->file_qr) && $mode_download != 'downloadWSDraft') {
    ...
    public function DirectESBSolar($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        ...
        $name = 'LHP-' . $no_lhp . '.pdf';
        // dd($name);
        $ress = self::formatTemplate($customBod, $header, $name, $ttd, $data->file_qr, $mode_download, $custom2 = null, $mpdf);
        return $ress;
    }

    public function lhpLingkungan($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        $methode_sampling = '';
        if (isset($data->metode_sampling)) {
            $methode_sampling = $data->metode_sampling;
        }
        if (isset($data->methode_sampling)) {
            $methode_sampling = $data->methode_sampling;
        }
        $period = explode(" - ", $data->periode_analisa);
                ...
                foreach ($data1 as $kk => $yy) {
                    ...
                    if ($p == $tot) {
                        $bodi .= '<tr>
                                                <td class="pd-5-solid-center">' . $p . '</td>
                                                <td class="pd-5-solid-left">' . $akr . '&nbsp;' . $yy['parameter'] . '</td>
                                                <td class="pd-5-solid-center">' . str_replace('.', ',', isset($yy['hasil']) ? $yy['hasil'] : $yy['hasil_uji']) . $yy['attr'] . '</td>
                                                <td class="pd-5-solid-left">' . $yy['methode'] . '</td>
                                            </tr>';
                    } else {
                        $bodi .= '<tr>
                                                <td class="pd-5-dot-center">' . $p . '</td>
                                                <td class="pd-5-dot-left">' . $akr . '&nbsp;' . $yy['parameter'] . '</td>
                                                <td class="pd-5-dot-center">' . str_replace('.', ',', isset($yy['hasil']) ? $yy['hasil'] : $yy['hasil_uji']) . $yy['attr'] . '</td>
                                                <td class="pd-5-dot-center">' . $yy['satuan'] . '</td>
                                                <td class="pd-5-dot-left">' . $yy['methode'] . '</td>
                                            </tr>';
                    }
    ...
    public function lhpSinarUV($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
    ...
    public function lhpMagnet($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
    ...
    public function lhpPencahayaan($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        $methode_sampling = $data->metode_sampling ? $data->metode_sampling : '-';
        $period = explode(" - ", $data->periode_analisa);
        $period = array_filter($period);
    ...
    public function lhpKebisingan($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        $methode_sampling = $data->metode_sampling ? $data->metode_sampling : '-';
        $period = explode(" - ", $data->periode_analisa);
        $period = array_filter($period);
    ...
    public function lhpKebisinganSesaat($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        $methode_sampling = $data->metode_sampling ? $data->metode_sampling : '-';
        $period = explode(" - ", $data->periode_analisa);
        $period = array_filter($period);
    ...
    public function lhpKebisinganPersonal($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        $methode_sampling = $data->metode_sampling ? $data->metode_sampling : '-';
        $period = explode(" - ", $data->periode_analisa);
        $period = array_filter($period);
    ...
    public function lhpKebisingan24Jam($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        // dd('masuk');
        $methode_sampling = $data->metode_sampling ? $data->metode_sampling : '-';
        $period = explode(" - ", $data->periode_analisa);
    ...
    public function lhpIklimPanas($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        $methode_sampling = $data->metode_sampling ? $data->metode_sampling : '-';
    ...
    public function lhpIklimDingin($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        $methode_sampling = $data->metode_sampling ? $data->metode_sampling : '-';
    ...
    public function lhpGetaran($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
    ...
    public function lhpGetaranPersonal($data, $data1, $mode_download, $custom, $custom2 = null, $mpdf)
    {
        // Get sampling method or default to '-'
        $methode_sampling = $data->metode_sampling ? $data->metode_sampling : '-';
    ...
    private function formatTemplate($bodi, $header, $filename, $ttd, $qr_img, $mode_download, $custom2, $mpdf)
    {
        // $mpdfConfig = array(
        //     'mode' => 'utf-8',
        //     'format' => 'A4',
