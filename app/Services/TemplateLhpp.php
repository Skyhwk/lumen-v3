...
class TemplateLhpp
{
    ...
    // Bagi item jadi chunk: 1 item pertama, lalu potongan 4-4
        ...
        $ttd = '
            <table style="font-family: Helvetica, sans-serif; font-size: 11px; margin-top: 100px; position: absolute; bottom: 0;" width="100%">
                <tr>';
        ...
        if ($mode_download == 'downloadLHPP') {
            ...
            $ttd .= '
                <td style="width: 50%; text-align: center;">
                    <table>
                        <tr><td>' . $tanggal_qr . '</td></tr>
                        <tr><td>Yang Memeriksa dan Menguji<br>Ahli K3 Lingkungan Kerja Muda</td></tr>
                        <tr><td style="height: 70px;"></td></tr>
                        <tr><td style="font-size: 10px; font-weight: bold;">' . $data->nama_skp_ahli_k3 . '</td></tr>
                        <tr><td style="font-size: 10px; font-weight: bold;">' . $data->no_skp_ahli_k3 . '</td></tr>
                    </table>
                </td>
            </tr>
        </table>';
