                ...
                if ($cekArray == []) {
                    ...
                    $pdf->writeHTML(
                        '<tr style="border: 1px solid; font-size: 9px;">
                            ...
                            <td style="font-size:9px;border:1px solid;border-color:#000; padding:5px;" rowspan="' . $rowspan . '"><span><b>' . $values->no_order . '</b></span><br><span><b>' . $values->no_document . '</b></span></td>'
                    );
