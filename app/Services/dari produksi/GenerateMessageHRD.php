                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td style="padding: 10px 0; text-align: justify;">
                                                            ...
                                                            <span style="font-weight: 600; color: black;">' . $data->name_posisi . '</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px 0; text-align: justify;">
                                                            ...
                                                            <table style="border: 3px solid;" cellpadding="0" cellspacing="0" width="600">
                                                                ...
                                                                <tr align="center">
                                                                    <td style="color: red;">
                                                                        ...
                                                                        <span style="font-weight: 600; text-decoration: underline;">membalas pesan Whatsapp pada nomor resmi perusahaan (0811-8185-731),</span>
    ...
    protected function bodyEmailCV($data)
    {
        ...
        <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 20px;">
            ...
            <div style="flex: 0 0 120px; text-align: center; margin-right: 20px;">
                <img src="https://apps.intilab.com/utc/apps/public/recruitment/foto/' . $data->foto_selfie . '" alt="Foto Kandidat" style="width: 120px; height: 120px; border-radius: 50%; margin-bottom: 15px;">
            </div>
        ...
        <div style="text-align: left; margin-bottom: 20px;">
            <ul style="list-style-type: none; padding: 0;">';
            $referensi = json_decode($data->referensi, true);
            $output .= '<li>
            ...
            <div style="width: 100%; max-width: 700px; margin: 0 auto; background-color: white; padding: 20px; border: 1px solid #ddd; box-sizing: border-box;">
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <ul style="padding-left: 20px;">
                        ...
                        <li><strong>Posisi yang Dilamar:</strong> ' . ($data->name_posisi ?: '-') . '</li>
                                            ...
                                            <td style="padding: 0 0 0 130px;">
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> : </td>
                                                        <td><span style="font-weight: 600; color: black;">' . $data->name_posisi . '</span></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td style="padding: 10px 0px 10px 0px; text-align: justify;">
                                                            Bersamaan dengan ini, kami informasikan bahwa 
                                                            <span style="font-weight: 600; color: black; text-decoration: underline;">
                                                                Terdapat perubahan jadwal interview HRD
                                                        ...
                                                        <table style="border: 3px solid;" cellpadding="0" cellspacing="0" width="600">
                                                            ...
                                                            <tr align="center">
                                                                <td style="color: red;">
                                                                    ...
                                                                    (0811-8185-731), dengan format sebagai berikut :
                                                                </td>
                                                            </tr>
                                                            <tr align="center">
                                                                <td style="color: red; font-weight: 600">Bersedia / Tidak Bersedia_Nama Lengkap</td>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 0px 0px 0px 130px;">
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>Bagian</td><td> : </td><td><span style="font-weight: 600; color: black;">' . $data->name_posisi . '</span></td>
                                                                    </tr>
                                                                    <tr>
