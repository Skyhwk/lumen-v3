    ...
    public function index($data, $id_parameter, $mdl) {
        ...
        foreach ($data->ks as $key => $value) {
            if(floatval($Vu) <= 0.0000) {
                ...
                // C (ug/Nm3) = (A/Vu)*1000
                $C = \str_replace(",", "", number_format(($value/$Vu) * 1000, 3));

                // C2 = C1/1000
                $C1 = \str_replace(",", "", number_format(($value/$Vu) / 1000 , 3));
            ...
            $C15 = \str_replace(",", "", number_format(($value/($data->average_flow*$data->durasi)) * 1000, 3));
        ...
        $C = array_sum($C_value) / count($C_value);
        $C1 = array_sum($C1_value) / count($C1_value);
        $C2 = array_sum($C2_value) / count($C2_value);
        $C14 = array_sum($C14_value) / count($C14_value);
