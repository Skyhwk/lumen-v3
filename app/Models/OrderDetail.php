...
class OrderDetail extends Sector
{
    ...
    {
        return $this->hasOne(OrderHeader::class, 'id', 'id_order_header')->with('sampling');
    }
    ...
    {
        // return $this->belongsTo(SampelDiantar::class, 'no_sampel', 'no_sample')->where('is_active', true);
    ...
    */
    ...
    {
        return $this->belongsTo(LhpsErgonomiHeader::class, 'cfr', 'no_lhp')->with('lhpsErgonomiDetail')->where('is_active', true);
    }
    ...
    public function pasikologi_data_lapangan()
    {
        return $this->hasMany(DataLapanganPsikologi::class, 'no_order', 'no_order')->with('header');
    }
    ...
    {
        return $this->belongsTo(DataLapanganPsikologi::class, 'no_sampel', 'no_sampel');
    }
