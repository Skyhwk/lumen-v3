...
class CopyKontrakJob extends Job
{
    protected $idcabang;
    protected $karyawan;
    protected $id;
    ...
    public function handle()
    {
        ...
        try {
            ...
            $query = QuotationKontrakH::where('id', $this->id)->firstOrFail();
            ...
            $query1 = QuotationKontrakD::where('id_request_quotation_kontrak_h', $this->id)->get();
