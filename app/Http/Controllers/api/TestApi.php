...
class TestApi extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
                ...
                if ($dataMethod) {
                    ...
                    switch ($methodName) {
                        case 'rwl':
                            ...
                            break;
                        case 'nbm':
                            $htmlContent = $render->ergonomiNbm($dataMethod,'',$templateSpecificCssNbm);
                            break;
                        case 'reba':
                            $htmlContent = $render->ergonomiReba($dataMethod,$globalCssContent,$rebaSpecificCss);
                            break;
            ...
            $createPDF = function($type) use ($mpdfConfig, $allHtmlContent, $noSampel, $dir) {
