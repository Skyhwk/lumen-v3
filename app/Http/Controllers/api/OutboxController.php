...
class OutboxController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $result = $this->mail()->fetchList('outbox', $page, $perPage, $query, $forceRefresh, $sort, $filter, $skipSync, $incrementalSync);
    ...
    public function viewDetail(Request $request)
    {
        try {
            ...
            $data = $this->mail()->getDetail('outbox', $uid);
    ...
    public function trash(Request $request)
    {
        try {
            $uid = $request->input('uid') ?? $request->input('id');
            $this->mail()->moveToTrash('outbox', $uid);
