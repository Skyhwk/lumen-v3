...
class GravimetriPadatanController extends Controller
{
    // public function index(Request $request){
    //     $data = Gravimetri::with('ws_value', 'order_detail')->where('is_approved', $request->approve)->where('is_active', true)->where('template_stp', $request->template_stp)->orderBy('created_at', 'desc');
