...
class WsFinalUdaraPencahayaanController extends Controller
{
        ...
        try {
            ...
            $idParameter = isset($parameterArray[0]) ? $parameterArray[0] : null;
                ...
                return Datatables::of($data)
                    ->addColumn('jenis_pengukuran', function ($item) {
                        $kategori = $item->data_lapangan->kategori ?? null;
                        return ($kategori == 'Pencahayaan Umum') ? 'umum' : 'lokal';
                    })
