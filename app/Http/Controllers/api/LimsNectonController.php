...
class LimsNectonController extends Controller
{
    public function index(Request $request){
        ...
        $data = Subkontrak::with('ws_value')
            ...
            ->select('subkontrak.*', 'order_detail.tanggal_terima as od_tanggal_terima', 'order_detail.kategori_3 as od_kategori_3')
            ->orderByRaw("
                    CASE 
