...
class LimsFdlObservasiKecerahanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = DataLapanganKecerahan::whereHas('detail', function ($query) use ($dbLims) {
