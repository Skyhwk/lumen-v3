...
class LimsFdlMedanLMController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = DataLapanganMedanLM::whereHas('detail', function ($query) use ($dbLims) {
    ...
    {
        $data = DataLapanganMedanLM::has('detail')->with('detail')->where('id', $request->id)->first();
