...
class FdlPartikulatIsokinetikMethod4Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($check) {
            ...
            try {
                $method2 = DataLapanganIsokinetikPenentuanKecepatanLinier::where('no_sampel', $request->no_sample)->first();
