    ...
    public function store(Request $request)
    {
            ...
            if ($request->tipe == 1) {
                ...
                try {
                    ...
                    if ($request->foto_lok != '') $data->foto_lokasi_sampel         = ImageConvertService::fromBase64($request->foto_lok, 1, $this->user_id, 'dokumentasi/sampling');
                    if ($request->foto_sampl != '') $data->foto_kondisi_sampel      = ImageConvertService::fromBase64($request->foto_sampl, 2, $this->user_id, 'dokumentasi/sampling');
