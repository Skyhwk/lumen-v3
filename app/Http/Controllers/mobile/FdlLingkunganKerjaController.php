...
class FdlLingkunganKerjaController extends Controller
{
    ...
    //         // if ($this->pin != null) {
    //         //     $txt = "Berhasil melakukan input Data Sampling : ";
    //         //     $txt .= "\n\n FDL : <b>Lingkungan Kerja</b>";
    //         //     $txt .= "\n Nomor Sample : <b>$request->no_sample</b> \n";
    //         //     foreach ($request->param as $in => $vale) {
    //         //         $txt .= "\n Parameter : <b>" . $vale . "</b>";
    //         //         if ($request->kateg_uji[$in] == null) {
    //         //             $shift_peng = 'Sesaat';
    //         //         } else if ($request->kateg_uji[$in] == '24 Jam') {
    ...
    //         //         $txt .= "\n Shift : <b>" . $shift_peng . "</b>";
    //         //     }
    //         //     $txt .= "\n\n Nama Sampler : <b>" . $nama . "</b>";
