...
class FdlMethodBahayaErgonomiController extends Controller
{
    ...
    // {
    //     dd($request->all());
    //     // if ($request->video_dokumentasi != '') {
    //     //         $data->foto_samping_kiri = self::convertBase64File(
    //     //             $request->video_dokumentasi,
    //     //             '_pengambilan',
    //     //             $this->user_id,
    //     //             'mp4'
    //     //         );
    ...
    public function storeVideo(Request $request)
    {
        ...
        return response()->json(['error' => 'File video tidak valid'], 400);
    }
