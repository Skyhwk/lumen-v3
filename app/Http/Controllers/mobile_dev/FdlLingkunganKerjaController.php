    ...
    public function getSample(Request $request)
    {
        if (isset($request->no_sample) && $request->no_sample != null) {
            ...
            if (is_null($data)) {
                ...
                $listParameter = ParameterFdl::select('parameters')->where('nama_fdl', 'lingkungan_kerja')->where('is_active', 1)->first();
                if ($detailLingkunganKerja !== NULL) {
                    ...
                    // } else {
                        ...
                        return response()->json([
                            ...
                            'param' => $param_fin,
                            'list_parameter' => $listParameter->parameters
                        ], 200);
                    // }
                }else {
                    $cek = MasterSubKategori::where('id', explode('-', $data->kategori_3)[0])->first();
