...
class FdlLingkunganHidupController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($request->param != null){
                // if (in_array('TSP', $request->param)) {
                    
                // }
                foreach ($request->param as $in => $a) {
                    $pengukuran = array();
                    $durasii = null;
                    if ($a == 'TSP (24 Jam)' || $a == 'Pb (24 Jam)' || $a == 'TSP 24J (UA)' || $a == 'PM 10 (24 Jam)' || $a == 'PM 10 (8 Jam)' || 
                        $a == 'PM 2.5 (24 Jam)' || $a == 'PM 2.5 (8 Jam)' || $a == 'PM 10 24J (UA)' || $a == 'PM 2.5 24J (UA)') {
