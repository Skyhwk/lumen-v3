...
class FdlDirectLainController extends Controller
{
    public function getSample(Request $request)
    {
        ...
        if (isset($request->no_sample) && $request->no_sample != null) {
            ...
            // $parameterList = [
            //     'C O', 'CO', 'CO (6 Jam)', 'CO (8 Jam)', 'CO (24 Jam)', 'CO2',
            //     'CO2 (8 Jam)', 'CO2 (24 Jam)', 'O2', 'VOC',
            //     'VOC (8 Jam)', 'H2CO', 'HCHO (8 Jam)'
            // ];

            $parameterList = ParameterFdl::select('parameters')->where('is_active', 1)->where('nama_fdl','direct_lain')->where('kategori','4-Udara')->first();
