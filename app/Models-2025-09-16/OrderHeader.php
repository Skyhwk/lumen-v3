...
class OrderHeader extends Sector
{
    ...
    public function all_qt_active()
    {
        return $this->hasMany(AllQtActive::class, 'no_document', 'no_document');
    }
    ...
    {
        return $this->hasMany(QuotationKontrakH::class, 'no_document', 'no_document')
            ->orWhereHas(QuotationNonKontrak::class, 'no_document', 'no_document');
    }

    public function invoices()
    {
        return $this->hasMany(Invoice::class, 'no_order', 'no_order')
            ->where('is_active', true);
    }

    public function persiapanHeader()
    {
        return $this->hasMany(PersiapanSampelHeader::class, 'no_order', 'no_order');
    }
