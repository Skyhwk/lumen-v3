...
class DataKandidat extends Sector
{
    ...
    {
        return $this->belongsTo(MasterDivisi::class, 'id_department', 'id');
    }
    public function review_user()
    {
        return $this->belongsTo(ReviewUser::class, 'id_review_user', 'id');
    }
    public function review_recruitment()
    {
        return $this->belongsTo(ReviewRecruitment::class, 'id_review_recruitment', 'id');
    }
    public function offering_salary()
    {
        return $this->belongsTo(OfferingSalary::class, 'id_salary', 'id');
    }
