...
class Subkontrak extends Sector
{
    ...
    public function ws_value_air()
    {
        return $this->hasOne('App\Models\WsValueAir', 'id_subkontrak', 'id')->where('is_active', true);
    }

    public function ws_value_udara()
    {
        return $this->hasOne('App\Models\WsValueUdara', 'id_subkontrak', 'id')->where('is_active', true);
    }

    // public function getHasilAttribute()
    // {
    //     return $this->ws_value_air->hasil;
    // }
