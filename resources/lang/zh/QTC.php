...
return [
    ...
    'terms_conditions' => [
        ...
        'general' => [
            ...
            '10' => "费用包括 :costs。",
            '11' => '实验室在所有检测活动中秉持独立性、公正性、客观性原则，并按照适用的政策和程序管理潜在的利益冲突。',
            '12' => '心理检测所需的数据必须在采样实施前至少3（三）个日历日收到。',
            '13' => '心理检测问卷的填写必须在问卷链接发送后最迟10（十）个日历日内完成。填写时间最多可延长3（三）次，自首次发送链接起总填写时间最长为30（三十）个日历日。若因填写延误导致问卷链接无法再次激活，则由客户自行承担全部责任。',
            '14' => '对于发电机组排放检测，客户必须确保发电机组在检测实施时处于可运行状态且功能正常/稳定。检测前须按正常运行条件预先准备并运行发电机组，以确保检测条件能够真实反映发电机组的实际运行状态。',
            '15' => '人体工学检测仅在客户同意检测过程中进行文件记录（照片/视频）的情况下方可实施，该记录是检测实施和/或检测结果文件编制的必要组成部分。',
        ],
    ],
    'tax' => [
        'vat' => '增值税 ',
