...
return [
    ...
    'discount' => [
        'contract' => [
            'water' => 'Contract Disc. Air ',
            'non_water' => 'Contract Disc. Non Air ',
            'air' => 'Contract Disc. Udara ',
            'emission' => 'Contract Disc. Emisi ',
            'transport' => 'Contract Disc. Transport ',
            'manpower' => 'Contract Disc. Perdiem ',
            'manpower24' => 'Contract Disc. Perdiem 24 Jam ',
            'operational' => 'Contract Disc. Analisa + Operasional ',
            'consultant' => 'Contract Disc. Consultant ',
            'group' => 'Contract Disc. Group ',
            'percent' => 'Contract Disc. Persen ',
    ...
    'summary' => [
        'header' => [
            'title' => 'Rincian Kontrak Pengujian - Periode',
            'contract' => 'No Contract',
            'pic' => 'PIC Sales',
            'price' => 'Keterangan Harga Pengujian',
        ],
        'discount' => [
            'water' => 'Contract Discount - Air ',
            'non_water' => 'Contract Discount - Non Air ',
            'air' => 'Contract Discount - Udara ',
            'emission' => 'Contract Discount - Emisi ',
            'transport' => 'Contract Discount - Transport ',
            'manpower' => 'Contract Discount - Perdiem ',
            'manpower24' => 'Contract Discount - Perdiem 24 Jam ',
            'operational' => 'Contract Discount - Analisa + Operasional ',
            'consultant' => 'Contract Discount - Consultant ',
            'group' => 'Contract Discount - Group ',
            'percent' => 'Contract Discount - Cash Discount Persen ',
