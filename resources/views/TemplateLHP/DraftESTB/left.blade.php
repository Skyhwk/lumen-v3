...
<div class="left">
    ...
    <tr>
        ...
        @if ($hasTerkoreksi)
            <th colspan="2" class="pd-5-solid-top-center" style="white-space: nowrap;">{{$header->header_table[0]}}</th>
        @else
            <th rowspan="1" class="pd-5-solid-top-center" style="white-space: nowrap;">{{$header->header_table[0]}}</th>
        @endif
