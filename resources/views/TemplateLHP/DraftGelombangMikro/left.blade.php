...
<div class="left">
    ...
    <div style="margin-bottom: 30px">
        <table
            ...
            <tbody>
                @php
                    $observasi = json_decode($header->hasil_observasi ?? '[]', true) ?? [];
                    $listObservasi = $observasi[0] ?? [];
                    $totalObservasi = count($listObservasi);
                    $extraRows = 3; // jumlah baris bayangan
                @endphp
        ...
        <table
            ...
            <tbody>
                @php
                    ...
                    $listKesimpulan = $kesimpulan[0] ?? [];
                    $totalKesimpulan = count($listKesimpulan);
                    $extraRowsKesimpulan = 3; // jumlah baris bayangan
                @endphp
