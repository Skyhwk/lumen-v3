        ...
        <div class="main-content">
            ...
            <div class="column-center">
                ...
                <table style="margin-top: 8px;">
                    ...
                    <tr class="final-score">
                        ...
                        <td style="font-weight: bold; font-size: 7px;">{{ $pengukuran->tindakan }}</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="column-right">
                ...
                <table class="reference-table">
                    ...
                    <tr>
                        <td style="font-size: 7px;">1</td>
                        <td style="font-size: 7px;">0</td>
                        <td style="font-size: 7px;">Sangat Rendah</td>
                        <td style="font-size: 7px;">Tidak ada tindakan yang diperlukan</td>
                    </tr>
                    <tr>
                        <td style="font-size: 7px;">2-3</td>
                        <td style="font-size: 7px;">1</td>
                        <td style="font-size: 7px;">Rendah</td>
                        <td style="font-size: 7px;">Mungkin diperlukan tindakan</td>
                    </tr>
                    <tr>
                        <td style="font-size: 7px;">4-7</td>
                        <td style="font-size: 7px;">2</td>
                        <td style="font-size: 7px;">Sedang</td>
                        <td style="font-size: 7px;">Diperlukan tindakan</td>
                    </tr>
                    <tr>
                        <td style="font-size: 7px;">8-10</td>
                        <td style="font-size: 7px;">3</td>
                        <td style="font-size: 7px;">Tinggi</td>
                        <td style="font-size: 7px;">Diperlukan tindakan segera</td>
                    </tr>
                    <tr>
                        <td style="font-size: 7px;">11-15</td>
                        <td style="font-size: 7px;">4</td>
                        <td style="font-size: 7px;">Sangat Tinggi</td>
                        <td style="font-size: 7px;">Diperlukan tindakan sesegera mungkin</td>
                    </tr>
                </table>
                <!-- Footer Notes -->
            ...
            <div class="bottom-left">
                <table>
                    <tr>
                        ...
                        <td style="width: 65%; text-align: justify; vertical-align: top; font-size: 8px;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: justify; vertical-align: top; font-size: 8px;">
