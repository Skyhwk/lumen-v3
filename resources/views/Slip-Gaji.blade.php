<table class="body" width="100%" style="vertical-align: top; border-collapse: collapse;" border="0">
    {{-- <table class="body" width="100%" style="vertical-align: top;" border="1" style="border-collapse: collapse;">
        ...
        <tr>
            <td width="35%">
                <img height="60px" src="{{ public_path() . '/img/isl_logo.png' }}" alt="ISL"
                    ...
                    <tr>
                        ...
                        <td width="40%" style="vertical-align: top;">
                            <svg width="325" height="92" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0" y="0" width="325" height="92" rx="10" ry="10" fill="transparent"
                                    stroke="lightgray" stroke-width="1" />

                                <text x="10" y="20" style="font-family: Arial, sans-serif; font-size: 11px;">Nama /
                                    NIK</text>
                                <text x="130" y="20" style="font-family: Arial, sans-serif; font-size: 11px;">:
                                    {{ $karyawan->nama }} ({{ $karyawan->nik }})</text>

                                <text x="10" y="35"
                                    style="font-family: Arial, sans-serif; font-size: 11px;">Department</text>
                                <text x="130" y="35" style="font-family: Arial, sans-serif; font-size: 11px;">:
                                    {{ $karyawan->divisi }}</text>

                                <text x="10" y="50"
                                    style="font-family: Arial, sans-serif; font-size: 11px;">Jabatan</text>
                                <text x="130" y="50" style="font-family: Arial, sans-serif; font-size: 11px;">:
                                    {{ $karyawan->jabatan }}</text>

                                <text x="10" y="65" style="font-family: Arial, sans-serif; font-size: 11px;">Tgl Mulai
                                    Bekerja</text>
                                <text x="130" y="65" style="font-family: Arial, sans-serif; font-size: 11px;">:
                                    {{ $karyawan->start_date }}</text>

                                <text x="10" y="80" style="font-family: Arial, sans-serif; font-size: 11px;">Periode
                                    Gaji</text>
                                <text x="130" y="80" style="font-family: Arial, sans-serif; font-size: 11px;">:
                                    {{ $periode }}</text>
                            </svg>
                ...
                <table class="keterangan" border="0" width="100%"
                    ...
                    <tr>
                        <td width="70%"
                            ...
                            @if ((isset($pendapatan->pencadangan_upah) && $pendapatan->pencadangan_upah > 0) || (isset($potongan->pencadangan_upah) && abs($potongan->pencadangan_upah) > 0))
                                <br><br><span style="font-size: 12px; font-style: italic;">*Pencadangan upah akan
                                    dikembalikan ketika masa pelatihan telah selesai</span>
                            @endif
                        </td>
                        <td width="30%">
                            <svg width="225" height="55" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0" y="0" width="225" height="55" rx="10" ry="10" fill="transparent"
                                    stroke="#000" stroke-width="1" />

                                <text x="112.5" y="15" style="font-family: Arial, sans-serif; font-size: 11px;"
                                    text-anchor="middle">Total Penerimaan Bulan Ini</text>

                                <text x="112.5" y="45"
                                    style="font-family: Arial, sans-serif; font-size: 28.8px; font-weight: bold;"
                                    text-anchor="middle">{{ number_format($pendapatan->take_home_pay, 0, ',', '.') }}</text>
                            </svg>
                        </td>
                        {{-- <td width="30%"
                            style="text-align: center; vertical-align: center; font-family: Arial; font-size: x-small; border: 1px solid #000;">
